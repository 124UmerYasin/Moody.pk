...
//    }
      let vc = UIAlertController(title: "Confirmation", message: "Are you sure want to download this image to gallery?", preferredStyle: .alert)
      vc.addAction(UIAlertAction(title: "yes", style: .default, handler: { UIAlertAction in
          DispatchQueue.global().async { [self] in
              if let url = URL(string: images[0].imageURL!.absoluteString),
      ...
      vc.addAction(UIAlertAction(title: "No", style: .cancel, handler: { UIAlertAction in
